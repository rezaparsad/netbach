...
urlpatterns = [
    ...
    path('server/detail/<int:pk>/', server_detail, name="server-detail"),
    path('server/detail/<int:pk>/info', server_info, name="server-info"),
    path('server/activity/<int:pk>/', server_activity, name="server-activity"),
    path('', home, name="home")
